...
//    }
    ...
    public void myAccount() {
        WebElement toggleButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > div.page-wrapper > header > div.panel.wrapper > div > ul > li.customer-welcome > span > button")));
...
//go to my account
        ...
        wait1.until(ExpectedConditions.elementToBeClickable(toggleButton));
        myaccount.click();
...
//remove second item from comparison list
        WebElement removeSecondProduct = driver.findElement(By.xpath("//a[@class='action delete' and @title='Remove Product']\n"));
...
//Go to view and Edit cart
        WebElement viewEditCart = driver.findElement(By.xpath("//*[@id=\"minicart-content-wrapper\"]/div[2]/div[5]/div/a"));
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
        viewEditCart.click();
